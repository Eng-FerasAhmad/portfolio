...
import ChaiIcon from '../chai/ChaiIcon';
...
import VuetifyIcon from '../vuetify/VuetifyIcon';
import VuexIcon from '../vuex/VuexIcon';
import WebpackIcon from '../webpack/WebpackIcon';
import YarnIcon from '../yarn/YarnIcon';
import ZeplinIcon from '../zeplin/ZeplinIcon';
...
export default function IconSelector({ iconName, color }: Props): JSX.Element {
    ...
    const iconSelector = (): ReactNode => {
        switch (iconName) {
            ...
            case 'vuetify':
                return <VuetifyIcon fill={isDarkTheme ? color : ''} />;
            case 'chai':
                return <ChaiIcon fill={isDarkTheme ? color : ''} />;
            case 'mocha':
                return <MochaIcon fill={isDarkTheme ? color : ''} />;
            case 'karma':
                return <KarmaIcon fill={isDarkTheme ? color : ''} />;
            case 'vuex':
                return <VuexIcon fill={isDarkTheme ? color : ''} />;
            case 'zeplin':
                return <ZeplinIcon fill={isDarkTheme ? color : ''} />;
            default:
                return <></>;
        }
    };
