...
export default function AdobeXdIcon(props: IconProps): ReactElement {
    return (
        <IconTemplate {...props} viewBox="0 0 2500 2437.5">
            <style type="text/css">
                {
                    '\n\t.st0{fill:#FF26BE;}\n\t.st1{fill:#2E001F;}\n\t.st2{fill:#FFD9F2;}\n'
                }
